...
"""
Django settings for blogging_dude project.
...
SECRET_KEY = 'django-insecure-=-(q(+6s+$la_x(t!vl3td#)b50!rd3s(e&tt)p4-9b&5ocrwf'
...
ROOT_URLCONF = 'blogging_dude.urls'
...
WSGI_APPLICATION = 'blogging_dude.wsgi.application'
